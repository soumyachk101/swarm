...
// A pane can unmount without its process dying: switching workHives, or
// crowning a bee (which moves it from the grid to the dock). Re-calling
 ...
 * true across a hide/remount (workHive switch, crowning), false once
