...
export default function TerminalPane({
  ...
  useEffect(() => {
    ...
    const spawnProcess = async () => {
      ...
      // This shell is still running — the pane was unmounted by a workhive
    ...
    const initTerminal = () => {
      try {
        const options: ITerminalOptions = {
          ...
          fontWeight: "400",
          fontWeightBold: "700",
          // 1 (xterm's own default), not >1 — see WorkerBeePane's initTerminal
        ...
        <div className="flex items-center gap-2 min-w-0">
          {isEditing && onEditChange ? (
            ...
            <span
              ...
              className="flex min-w-0 items-center gap-1.5 truncate text-xs text-bee-text font-medium cursor-pointer hover:text-bee-textDim transition-colors"
              title={displayName}
            >
              <span
