 ...
 *   Amber    - the warm hive identity, held back so it stays a workplace.
 *
...
export const THEMES: ThemeDef[] = [
  ...
  },
  {
    id: "amber",
    label: "Amber",
    description: "The warm hive, kept restrained",
...
const TOKEN_TO_CSS: Record<keyof ThemeTokens, string> = {
  canvas: "--bee-canvas",
  canvasHi: "--bee-canvas-hi",
  surface: "--bee-surface",
  surfaceHi: "--bee-surface-hi",
  border: "--bee-border",
  borderHi: "--bee-border-hi",
  gold: "--bee-gold",
  goldHi: "--bee-gold-hi",
  goldDim: "--bee-gold-dim",
  honey: "--bee-honey",
  amber: "--bee-amber",
  text: "--bee-text",
  textDim: "--bee-text-dim",
  textMuted: "--bee-text-muted",
  ok: "--bee-ok",
  warn: "--bee-warn",
  err: "--bee-err",
};
...
/** Accent hex for the active (or given) theme — workhive chips, defaults, etc. */
