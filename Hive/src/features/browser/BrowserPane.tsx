    ...
    <div className="flex h-full flex-col overflow-hidden glass-body">
      ...
      <div data-pane-drag data-pane-header="true" className={`${PANE_HEADER_CLASS} gap-1 px-1.5`}>
        <span
          ...
          aria-hidden
        />
        <Globe className="size-3 shrink-0 text-bee-textMuted" />
        <button
        ...
        <input
          ...
          spellCheck={false}
          className="mx-1 min-w-0 flex-1 rounded-md border border-bee-border/50 glass-inset px-2 py-0.5 text-mini text-bee-text outline-none transition-colors placeholder:text-bee-textMuted/50 focus:border-bee-gold/40"
        />
      ...
      <div ref={viewRef} className="relative min-h-0 flex-1 overflow-hidden">
        ...
        {status === "error" && (
          <div className="flex h-full flex-col items-center justify-center gap-2 px-6 text-center">
            ...
            <p className="text-mini font-medium text-bee-err">Preview engine didn't start</p>
            <p className="max-w-[380px] text-micro leading-[1.5] text-bee-textMuted">{error}</p>
            <p className="max-w-[380px] text-micro leading-[1.5] text-bee-textMuted/70">
            ...
            <button
              ...
              className="mt-1 rounded-md border border-bee-gold/30 bg-bee-gold/10 px-2.5 py-1 text-micro font-medium text-bee-goldHi transition-colors hover:bg-bee-gold/20"
            >
              Retry
            </button>
          </div>
