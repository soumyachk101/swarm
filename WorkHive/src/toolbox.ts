/**
 * The workhive toolbox: the skills and MCP servers that every agent in a
 * workhive gets, WorkerBees and QueenBee alike.
 *
 * The delivery mechanism is the folder itself. Every agent in a workhive is
 * spawned with its cwd inside that workhive, and every CLI worth using reads
 ...
 * Nectar writes itself in there, and a user may have added their own by hand.
...
/**
 * Every directory a toolbox must be written into for one workhive: the bound
