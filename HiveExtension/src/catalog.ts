/**
 * The extensions Hiveory offers — a curated shelf, not the whole Open-VSX
 * registry. Everything here is either an AI coding agent (which can join the
 * hive as a WorkerBee and be crowned QueenBee) or a development tool that earns
 * its place in a pane.
 *
...
export const EXTENSION_CATALOG: CatalogEntry[] = [
  // ── Agents: these panes behave like WorkerBees and can wear the crown ──
  {
  ...
  // ── Tools: ordinary editor panes, no crown ──
  {
    ...
    name: "Postman",
    publisher: "Postman",
    description: "Send API requests and manage collections without leaving the hive.",
    role: "tool",
  },
  {
    id: "eamodio.gitlens",
