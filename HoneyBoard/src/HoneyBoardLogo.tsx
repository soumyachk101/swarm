/**
 * The HoneyBoard mark. HoneyBoard is the strip that carries panes between
 * planes, so the mark is what that actually is: three comb cells packed the
 * way real comb packs, with a drop of honey moving through the middle one.
 * A lone hexagon said "honeycomb"; this says "work moving across the comb",
 ...
 */
export default function HoneyBoardLogo({ size = 22, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
