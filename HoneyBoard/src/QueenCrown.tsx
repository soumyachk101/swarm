/**
 * The QueenBee mark. Not a crown: crowns are everywhere and say "premium",
 * not "this agent leads the hive". This is the queen herself, sharing the
 * WorkerBee silhouette exactly so promoting a worker reads as the same
