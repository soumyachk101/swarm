...
/**
 * Reads/writes `.pheromone/agents/handoffs/<taskId>.md`.
 *
...
export class HandoffManager {
  ...
  constructor(pheromonePath: string, private fs: HandoffFs) {
    this.handoffsDir = joinPath(pheromonePath, '.pheromone', 'agents', 'handoffs');
  }
