/**
 * The HoneyFlow mark: nodes scattered in open space, linked. It has to read as
 * "a canvas of connected work" next to HoneyBoard's "cells in a grid", because
 * those two marks are the whole toggle.
 */
export default function HoneyFlowMark({ size = 22, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-label="HoneyFlow">
