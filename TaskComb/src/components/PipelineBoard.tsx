...
const CONNECTOR_COLOR = "rgb(var(--bee-gold))";
...
const PAL: Record<string, Palette> = {
  ...
  aggregator:  { icon: Layers,     accent: "rgb(var(--bee-gold))" },
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "linear-gradient(180deg, rgb(var(--bee-surface-hi)) 0%, rgb(var(--bee-canvas-hi)) 100%)",
        border: "1px solid rgb(var(--bee-border))",
    ...
    >
      <div className="flex items-center gap-1.5 min-w-0">
        <span
          ...
          style={{ background: "rgb(var(--bee-gold) / 0.13)", color: n.accent }}
        >
      ...
      {n.statusText && (
        <span className="text-micro text-bee-textMuted leading-[1.35] truncate mt-auto pb-px">
          {n.statusText}
        </span>
      )}
    </div>
