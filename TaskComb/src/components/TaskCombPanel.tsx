...
interface Props {
  ...
  onClose: () => void;
  /** Content for the History tab. Injected so TaskComb stays a board package
   *  and never has to know about Nectar's session store. */
...
export default function TaskCombPanel({ open, tasks, statuses = {}, onClose, history }: Props) {
  ...
  return (
    <div
      ...
      className="relative flex flex-col glass-rail border-t border-bee-border/50 shrink-0"
      style={{ height }}
    >
